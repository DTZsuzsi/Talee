...
public class Event {
    ...
    public Event(long id, LocalDate date, String name, String description, Location location, Set<User> users, String owner, String size, List<Tag> tags, String status) {
        this.id = id;
        this.date = date;
        this.name = name;
